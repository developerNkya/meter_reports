...
class ChooseReceiptsDate extends StatefulWidget {
  ChooseReceiptsDate({Key? key}) : super(key: key);

  @override
  State<ChooseReceiptsDate> createState() => _ChooseReceiptsDateState();
}

class _ChooseReceiptsDateState extends State<ChooseReceiptsDate> {
  late GSForm form;
  String selectedTime = '';
  ...
  void _submitForm() {
    if (fromDate != null &&
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) =>ShiftReceipts(dateFrom: resultingFromDate,fromTime: fromTime,dateTo:resultingToDate,toTime: toTime)),
      );
