...
import 'package:grocery_app/screens/shift_management/fetchShiftReport.dart';
import 'package:grocery_app/screens/shift_management/print_shit_receipts.dart';
...
class ShiftReceipts extends StatefulWidget {
  final int? id;
  final String? dateTo;
  ...
  @override
  State< ShiftReceipts> createState() => _ShiftReceiptsState();
}

class _ShiftReceiptsState extends State<ShiftReceipts> {
  ...
  stationReceipt() async {
   ...
   var userSummary = await fetchShiftReport(auth, dateFrom, dateTo);
    if (userSummary != null) {
      Map<String, dynamic> summaryMap = userSummary;

      print(summaryMap);

      Map<String, dynamic> data = summaryMap;
      int id = data['id'];
...
// Set other values
      dateFrom = "${widget.dateFrom}"; // Replace with your actual 'from' value if available
